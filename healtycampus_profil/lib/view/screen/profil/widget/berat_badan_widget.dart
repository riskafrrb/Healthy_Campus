...
class BeratBadanWidget extends StatefulWidget {
  const BeratBadanWidget({super.key});

  @override
  _BeratBadanWidgetState createState() => _BeratBadanWidgetState();
}

class _BeratBadanWidgetState extends State<BeratBadanWidget> {
  String _unit = 'kg';
