...
import 'riwayat_juli.dart';
import 'lacak_aktivitas.dart'; // Import halaman lacak_aktivitas

class RiwayatApril extends StatelessWidget {
  const RiwayatApril({super.key});
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _buildMonthButton(context, 'April', 'april', true),
                      _buildMonthButton(context, 'Mei', 'mei', false),
                      _buildMonthButton(context, 'Juni', 'juni', false),
                      _buildMonthButton(context, 'Juli', 'juli', false),
                    ],
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Expanded(
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16),
                      child: Image.asset(
                        'assets/image/aktivitas_april.png',
                        fit: BoxFit.fitWidth,
                      ),
                    ),
                  ),
